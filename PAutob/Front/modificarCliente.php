                ...
                if($result->num_rows>0){
                    while($row = $result->fetch_assoc()){?> 
                       <tr>
                           ...
                           <form id="modificar" method="post" action="modificarCli.php">
                    <td> <input type="submit" class="btn btn-primary" value="MODIFICAR"></td>
                    <input type="text" name="id_cli"  value="<?php echo $row['id_cli'];?>" style="display:none;">
                    </form>
                       </tr>
                       <?php
                    }
